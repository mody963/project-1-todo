...
//     }
//     public void SaveIfDirty(IMyCollection<Task_Allocation> allocations)
//     {
//         if (!allocations.Dirty)
//             return;

//         SaveTaskAllocations(allocations);

//         if (allocations is MyArrayList<Task_Allocation> list)
//             list.ResetDirty();
//     }
// }